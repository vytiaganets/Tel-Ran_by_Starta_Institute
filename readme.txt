...
7. В чем разница между абстрактными классами и интерфейсами?
8. Что такое перегрузка метода и переопределение метода?
9. Объясните Bean в Spring и перечислите различные области применения.
10. Чем является интерфейс в Java?
11. Какие важные аннотации Spring вы использовали?
...
https://discordapp.com/channels/1081271040497434785/1121818984497565696

Для Front-end:
1. Какие есть обязательные атрибуты у тега img? Расскажите про их назначение
2. Что такое семантические теги? Зачем они нужны?
3. Какие вы знаете способы комбинирования селекторов?
4. Что такое флексы и гриды? В чем между ними разница? В чем их преимущества?
5. В чем разница между let, const и var?
6. В чем разница между function declaration, function expression и arrow function?
7. Что такое замыкания?
8. Что такое callback-функция?
9. Какие вы знаете методы массивов? Расскажите, как работают эти методы
10. Что такое React?
11. Что такое JSX?
12. Что такое props?
13. Что такое prop drilling и с помощью чего этого можно избежать?
14. Зачем нужен специальный атрибут key?
15. Что такое Redux?

Для QA:
1. Назовите основные модели разработки ПО.
2. Чем юнит тестирование отличается от интеграционного?
3. Какая главная цель использования техники boundary value analysis в тестировании?
4. В чем принципиальное отличие waterfall модели от инкрементно-итеративной?
5. Чем интеграционное тестирование отличается от системного?
6. В чем принципиальное отличие QA engineer от Tester?
7. В чем отличие верификации от валидации?
8. В чем принципиальное отличие black box testing от white box testing?
9. Какая главная цель использования техники Exploratory testing?
10. Чем отличается V-модель от Waterfall с позиции тестирования?
11. В чем принципиальное отличие Smoke testing от Regression testing?
12. Какая главная цель использования техники Monkey testing?
13. В чем разница инкрементной модели от итеративной?
14. В чем принципиальное отличие Positive testing от Negative testing?
...
https://airtable.com/apprdK6RSuHRwWXO9/shrnMJjRvEkeZnCJe Вопросы на консультации
https://airtable.com/appQWRUJA8s7JBJHn/shrMHsqzD0ZqyPEk1/tblvIBp9Y86Xae4k5/viwpcGOZ7CoxupF7B
