...
--Найти сотрудников, 
--у которых зарплата меньше средней зарплаты по компании
...
--1. Найти количество департаментов, в которых никто не работает
left join, right join, count(*)

-- 1. Найти и вывести департаменты, 
--в которых никто не работает
...
-- Найти количество сотрудников из департамента 
--с айди 100, которые зарабатывают более 5000
...
Вывести сотрудников(first_name, last_name, salary) 
--с дольжностью(job_title) Programmer,  
